...
Vue.component('vue-player', {
    props: ['index', 'player'],
    template: `
        <a-entity geometry="primitive: sphere; segmentsWidth: 4; segmentsHeight: 4; radius: 1;" color="red" :position="player.x + ' ' + player.y + ' ' + player.z" :io3d-player="socket.id"></a-entity>`,
    data () {
